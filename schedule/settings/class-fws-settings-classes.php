<?php
/**
 * Creates classes metabox in settings
 *
 * PHP Version: 7.3
 *
...
/**
 * [Description FWS_Settings_Classes]
 */
class FWS_Settings_Classes extends FacultyWeeklySchedule_AdminPageFramework_PageMetaBox {
...
new FWS_Settings_Classes(
	null,                                           // meta box id - passing null will make it auto generate.
	__( 'Classes Default Options', 'faculty-weekly-schedule' ), // title.
	array( 'fws_settings_page' => array( 'fws_classes_tab' ) ),
	'normal',                                         // context.
	'default'                                       // priority.
);
