...
abstract class FacultyWeeklySchedule_AdminPageFramework_UserMeta_Model extends FacultyWeeklySchedule_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData()
    {
        $_iUserID = isset($GLOBALS[ 'profileuser' ]->ID) ? $GLOBALS[ 'profileuser' ]->ID : 0;
        $_oMetaData = new FacultyWeeklySchedule_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
