...
abstract class FacultyWeeklySchedule_AdminPageFramework_Utility_Deprecated {
    ...
    static public function getAttributes(array $aAttributes) {
        FacultyWeeklySchedule_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'FacultyWeeklySchedule_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    class FacultyWeeklySchedule_AdminPageFramework_Utility extends FacultyWeeklySchedule_AdminPageFramework_Utility_HTMLAttribute {
