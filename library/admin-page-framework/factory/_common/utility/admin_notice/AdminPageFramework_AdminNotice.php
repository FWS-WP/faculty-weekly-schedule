...
class FacultyWeeklySchedule_AdminPageFramework_AdminNotice extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes=array( 'class' => 'error' ), array $aCallbacks=array())
    {
        ...
        $this->aAttributes[ 'class' ] = $this->getClassAttribute($this->aAttributes[ 'class' ], 'faculty-weekly-schedule-settings-notice-message', 'faculty-weekly-schedule-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new FacultyWeeklySchedule_AdminPageFramework_AdminNotice___Script;
        if (! $sNotice) {
            return;
        }
