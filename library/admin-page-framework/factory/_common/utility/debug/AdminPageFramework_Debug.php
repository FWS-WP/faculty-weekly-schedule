...
class FacultyWeeklySchedule_AdminPageFramework_Debug_Base extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    class FacultyWeeklySchedule_AdminPageFramework_Debug extends FacultyWeeklySchedule_AdminPageFramework_Debug_Log {
        ...
        static public function getAsString($mValue) {
            self::showDeprecationNotice('FacultyWeeklySchedule_AdminPageFramework_Debug::' . __FUNCTION__);
