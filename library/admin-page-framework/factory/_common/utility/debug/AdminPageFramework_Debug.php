...
class FacultyWeeklySchedule_AdminPageFramework_Debug extends FacultyWeeklySchedule_AdminPageFramework_Debug_Log {
    ...
    {
        self::showDeprecationNotice('FacultyWeeklySchedule_AdminPageFramework_Debug::' . __FUNCTION__, 'FacultyWeeklySchedule_AdminPageFramework_Debug::dump()');
        FacultyWeeklySchedule_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    public static function getArray($asArray, $sFilePath=null, $bEscape=true)
    {
        self::showDeprecationNotice('FacultyWeeklySchedule_AdminPageFramework_Debug::' . __FUNCTION__, 'FacultyWeeklySchedule_AdminPageFramework_Debug::get()');
        return FacultyWeeklySchedule_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    public static function logArray($asArray, $sFilePath=null)
    {
        self::showDeprecationNotice('FacultyWeeklySchedule_AdminPageFramework_Debug::' . __FUNCTION__, 'FacultyWeeklySchedule_AdminPageFramework_Debug::log()');
        FacultyWeeklySchedule_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
}
