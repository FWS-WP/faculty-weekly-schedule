...
class FacultyWeeklySchedule_AdminPageFramework_WPUtility_URL extends FacultyWeeklySchedule_AdminPageFramework_Utility {
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = FacultyWeeklySchedule_AdminPageFramework_Utility::getRelativePath(preg_replace('/[\/\\\\]wp-content$/', '', rtrim(WP_CONTENT_DIR, '/\\')), $sFilePath);
    ...
    class FacultyWeeklySchedule_AdminPageFramework_WPUtility extends FacultyWeeklySchedule_AdminPageFramework_WPUtility_SystemInformation {
