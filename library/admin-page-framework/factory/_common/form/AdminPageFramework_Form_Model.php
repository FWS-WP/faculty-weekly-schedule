...
class FacultyWeeklySchedule_AdminPageFramework_Form_Model extends FacultyWeeklySchedule_AdminPageFramework_Form_Base {
    public $aArguments;
    ...
    public function getSortedInputs(array $aFormInputs)
    {
        ...
        $_oInputSorter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    {
        $_oFilterRepeatableElements = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getHTTPRequestSanitized($this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments[ 'structure_type' ])));
    ...
    public function _replyToRegisterFormItems()
    {
        ...
        $_oFieldResources = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
    ...
    private function _setSiteWideFieldTypeDefinitions()
    {
        ...
        $_oBuiltInFieldTypeDefinitions = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    {
        $_oDefaultValues = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData)
    {
        $_oSectionsetsFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments[ 'structure_type' ], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments[ 'structure_type' ], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
