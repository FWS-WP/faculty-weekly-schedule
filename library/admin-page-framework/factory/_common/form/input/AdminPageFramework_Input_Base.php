...
abstract class FacultyWeeklySchedule_AdminPageFramework_Input_Base extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array( 'input_container_tag' => 'span', 'input_container_attributes' => array( 'class' => 'faculty-weekly-schedule-input-container', ), 'label_container_tag' => 'span', 'label_container_attributes' => array( 'class' => 'faculty-weekly-schedule-input-label-string', ), );
