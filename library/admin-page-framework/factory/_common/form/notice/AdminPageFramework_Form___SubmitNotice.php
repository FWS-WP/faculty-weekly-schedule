...
class FacultyWeeklySchedule_AdminPageFramework_Form___SubmitNotice extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    {
        new FacultyWeeklySchedule_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices)
    {
        ...
        foreach (array_filter(( array ) $aNotices, 'is_array') as $_aNotice) {
            ...
            new FacultyWeeklySchedule_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
