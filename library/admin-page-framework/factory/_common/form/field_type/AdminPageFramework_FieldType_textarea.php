...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getFacultyWeeklySchedule_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getFacultyWeeklySchedule_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.faculty-weekly-schedule-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.faculty-weekly-schedule-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeFacultyWeeklySchedule_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field-textarea .faculty-weekly-schedule-input-label-string {vertical-align: top;margin-top: 2px;} .faculty-weekly-schedule-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.faculty-weekly-schedule-field-textarea.faculty-weekly-schedule-field .faculty-weekly-schedule-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .faculty-weekly-schedule-field-textarea .faculty-weekly-schedule-input-label-container {width: 100%;}.faculty-weekly-schedule-field-textarea textarea {max-width: 100%;}";
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='faculty-weekly-schedule-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
