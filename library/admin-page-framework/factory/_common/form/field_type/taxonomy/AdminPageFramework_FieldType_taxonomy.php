...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_taxonomy extends FacultyWeeklySchedule_AdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'faculty-weekly-schedule-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'faculty-weekly-schedule-script-form-main' ), 'translation_var' => 'FacultyWeeklySchedule_AdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
