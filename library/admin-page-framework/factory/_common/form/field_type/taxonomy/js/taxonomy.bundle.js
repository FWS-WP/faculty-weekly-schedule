...
(function($){
  ...
  var apfTaxonomy = FacultyWeeklySchedule_AdminPageFrameworkFieldTypeTaxonomy;
  ...
  $( document ).ready( function(){
    ...
    /* For tabs */
    var enableFacultyWeeklySchedule_AdminPageFrameworkTabbedBox = function ( nodeTabBoxContainer ) {
    ...
    enableFacultyWeeklySchedule_AdminPageFrameworkTabbedBox( $( '.tab-box-container' ) );
    ...
    $().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Initialize
          enableFacultyWeeklySchedule_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
