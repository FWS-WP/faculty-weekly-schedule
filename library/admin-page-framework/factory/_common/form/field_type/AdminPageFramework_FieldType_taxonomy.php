...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_taxonomy extends FacultyWeeklySchedule_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
...
jQuery( document ).ready( function() {
    ...
    enableFacultyWeeklySchedule_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.faculty-weekly-schedule-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.faculty-weekly-schedule-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.faculty-weekly-schedule-field .taxonomy-checklist ul ul {margin-left: 1em;}.faculty-weekly-schedule-field .taxonomy-checklist-label {white-space: nowrap; }.faculty-weekly-schedule-field .tab-box-container.categorydiv {max-height: none;}.faculty-weekly-schedule-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.faculty-weekly-schedule-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.faculty-weekly-schedule-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.faculty-weekly-schedule-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.faculty-weekly-schedule-field .tab-box-tabs li a { color: #333; text-decoration: none; }.faculty-weekly-schedule-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.faculty-weekly-schedule-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.faculty-weekly-schedule-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.faculty-weekly-schedule-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.faculty-weekly-schedule-field .tab-box-content:target, .faculty-weekly-schedule-field .tab-box-content:target, .faculty-weekly-schedule-field .tab-box-content:target { display: block; }.faculty-weekly-schedule-field .tab-box-content .select_all_button_container, .faculty-weekly-schedule-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.faculty-weekly-schedule-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
