...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_submit extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field input[type='submit'] {margin-bottom: 0.5em;}.faculty-weekly-schedule-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.faculty-weekly-schedule-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.faculty-weekly-schedule-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.faculty-weekly-schedule-field-submit' ).find( 'input[type=submit]' ).click( function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.faculty-weekly-schedule-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.faculty-weekly-schedule-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
