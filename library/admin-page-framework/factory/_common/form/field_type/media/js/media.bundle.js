...
var apfMedia = FacultyWeeklySchedule_AdminPageFrameworkMediaFieldType;
...
(function ( $ ) {
  ...
  var setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMedia.on( 'click', function () {
          ...
          window.send_to_editor = hfFacultyWeeklySchedule_AdminPageFrameworkSendToEditorMedia;
      ...
      var hfFacultyWeeklySchedule_AdminPageFrameworkSendToEditorMedia = function ( sRawHTML, param ) {
      ...
      setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMediaButton.on( 'click', function ( e ) {
          ...
          oFacultyWeeklySchedule_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object.
          wp.media.view.MediaFrame.Select = fExternalSource ? getFacultyWeeklySchedule_AdminPageFrameworkCustomMediaUploaderSelectObject() : oFacultyWeeklySchedule_AdminPageFrameworkOriginalMediaUploaderSelectObject;
          ...
          _oMediaUploader.on( 'close', function () {
            ...
            wp.media.view.MediaFrame.Select = oFacultyWeeklySchedule_AdminPageFrameworkOriginalMediaUploaderSelectObject;
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
...
console.log( 'media field inputs not found' );
            ...
            setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader(
