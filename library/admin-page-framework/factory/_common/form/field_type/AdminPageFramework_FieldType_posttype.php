...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.faculty-weekly-schedule-checkbox-label {margin-top: 0.1em;}.faculty-weekly-schedule-field input[type='checkbox' ] {margin-right: 0.5em;} .faculty-weekly-schedule-field-checkbox .faculty-weekly-schedule-input-label-container {padding-right: 1em;}.faculty-weekly-schedule-field-checkbox .faculty-weekly-schedule-input-label-string{display: inline; }";
    }
    ...
    class FacultyWeeklySchedule_AdminPageFramework_FieldType_posttype extends FacultyWeeklySchedule_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".faculty-weekly-schedule-field input[type='checkbox'] {margin-right: 0.5em;} .faculty-weekly-schedule-field-posttype .faculty-weekly-schedule-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
