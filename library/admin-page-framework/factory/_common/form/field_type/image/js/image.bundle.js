...
var apfImage = FacultyWeeklySchedule_AdminPageFrameworkImageFieldType;
apfImage.hasMediaUploader = !! apfImage.hasMediaUploader;
(function ( $ ) {

  var setFacultyWeeklySchedule_AdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfImage.hasMediaUploader ) {
       ...
       */
      setFacultyWeeklySchedule_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function () {
          ...
          window.send_to_editor = hfFacultyWeeklySchedule_AdminPageFrameworkSendToEditorImage;
      ...
      var hfFacultyWeeklySchedule_AdminPageFrameworkSendToEditorImage = function ( sRawHTML ) {
      ...
      setFacultyWeeklySchedule_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function ( e ) {
          ...
          oFacultyWeeklySchedule_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object
          wp.media.view.MediaFrame.Select = fExternalSource ? getFacultyWeeklySchedule_AdminPageFrameworkCustomMediaUploaderSelectObject() : oFacultyWeeklySchedule_AdminPageFrameworkOriginalImageUploaderSelectObject;
          ...
          _oCustomImageUploader.on( 'close', function () {
            ...
            if ( typeof (_oImage) !== 'undefined' ) {
              ...
              _oCustomImageUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.faculty-weekly-schedule-field' )
                  : _oNewField;
                _oNewField = $( this ).addFacultyWeeklySchedule_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oFacultyWeeklySchedule_AdminPageFrameworkOriginalImageUploaderSelectObject;
    ...
    $().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Bind the event.
          var _oFieldContainer = oCloned.closest( '.faculty-weekly-schedule-field' );
          ...
          setFacultyWeeklySchedule_AdminPageFrameworkImageUploader(
    ...
    $( '.select_image.button' ).each( function() {
      setFacultyWeeklySchedule_AdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
