            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.faculty-weekly-schedule-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addFacultyWeeklySchedule_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.faculty-weekly-schedule-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .faculty-weekly-schedule-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .faculty-weekly-schedule-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.faculty-weekly-schedule-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.faculty-weekly-schedule-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.faculty-weekly-schedule-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.faculty-weekly-schedule-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.faculty-weekly-schedule-field .image_preview {max-width: 600px;}}.faculty-weekly-schedule-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.faculty-weekly-schedule-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
jQuery( document ).ready( function(){     
    setFacultyWeeklySchedule_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
        ...
        private function _getScript_MediaUploader($sReferrer) {
            ...
            if (!function_exists('wp_enqueue_media')) {
                return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
...
JAVASCRIPTS;
            ...
            return <<<JAVASCRIPTS
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.faculty-weekly-schedule-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
JAVASCRIPTS;
        ...
        protected function getStyles() {
            return ".faculty-weekly-schedule-field-media input {margin-right: 0.5em;vertical-align: middle;}@media screen and (max-width: 782px) {.faculty-weekly-schedule-field-media input {margin: 0.5em 0.5em 0.5em 0;}} .select_media.button.button-small,.remove_media.button.button-small{ vertical-align: middle;}.remove_media.button.button-small {margin-left: 0.2em;}";
        }
        protected function _getPreviewContainer($aField, $sImageURL, $aPreviewAtrributes) {
            return "";
        }
...
jQuery( document ).ready( function(){   
    setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
            return "<script type='text/javascript' class='faculty-weekly-schedule-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
        }
