...
(function($){
  ...
  /** global: FacultyWeeklySchedule_AdminPageFrameworkFieldTypeTextArea */
  var apfTextArea = FacultyWeeklySchedule_AdminPageFrameworkFieldTypeTextArea;
  ...
  $( document ).ready( function(){
    ...
    var updateFoundEditors = function ( oElements ) {
      ...
      oElements.each( function ( iIndex ) {
        ...
        var oSettings = $().getFacultyWeeklySchedule_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );
    ...
    $().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          var _oSettings = $().getFacultyWeeklySchedule_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );

          // Elements
          var _oField = oCloned.closest( '.faculty-weekly-schedule-field' );
        ...
        stopped_sorting_fields: function ( oSortedFields, sFieldType, sFieldsTagID, iCallType ) {
          ...
          // Update the editor.
          setTimeout( function () {
            var _oFields = oSortedFields.children( '.faculty-weekly-schedule-field' );
        ...
        stopped_sorting_sections: function ( oSections ) {
          ...
          setTimeout( function () {
            var _oFields = $( oSections ).find( '.faculty-weekly-schedule-field' );
            updateFoundEditors( _oFields );
          }, 100 );
        ...
        saved_widget: function ( oWidget ) {
          ...
          $( oWidget ).find( '.faculty-weekly-schedule-field' ).each( function ( iIndex ) {
            ...
            // Store the settings.
            $().storeFacultyWeeklySchedule_AdminPageFrameworkInputOptions(
              oWrap.attr( 'data-id' ),
              {
    ...
    // Initialize
    $( '.faculty-weekly-schedule-textarea-data-input' ).each( function(){
