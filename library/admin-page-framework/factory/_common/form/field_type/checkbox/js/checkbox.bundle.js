...
(function($){
  ...
  var apfCheckBox = FacultyWeeklySchedule_AdminPageFrameworkFieldTypeCheckbox;
  ...
  $( document ).ready( function(){
    ...
    $( document ).ready( function(){
      ...
      _body.on( 'click', '.select_all_button_container', function() {
        $( this ).selectAllFacultyWeeklySchedule_AdminPageFrameworkCheckboxes();
        return false;
      } );
      ...
      _body.on( 'click', '.select_none_button_container', function() {
        $( this ).deselectAllFacultyWeeklySchedule_AdminPageFrameworkCheckboxes();
        return false;
      } );
    });
