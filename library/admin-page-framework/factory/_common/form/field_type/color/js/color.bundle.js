...
(function ( $ ) {
  ...
  var apfColor = FacultyWeeklySchedule_AdminPageFrameworkColorFieldType;

  var registerFacultyWeeklySchedule_AdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.faculty-weekly-schedule-field-color-picker' ).each( function () {
      registerFacultyWeeklySchedule_AdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
    ...
    $().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          oCloned.find( 'input.input_color' ).each( function ( iIterationIndex ) {
            ...
            registerFacultyWeeklySchedule_AdminPageFrameworkColorPickerField( _oNewColorInput );
