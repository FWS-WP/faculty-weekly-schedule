...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_text extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field.faculty-weekly-schedule-field-text > .faculty-weekly-schedule-input-label-container {vertical-align: middle; }.faculty-weekly-schedule-field.faculty-weekly-schedule-field-text > .faculty-weekly-schedule-input-label-container.faculty-weekly-schedule-field-text-multiple-labels {display: block;}";
    }
