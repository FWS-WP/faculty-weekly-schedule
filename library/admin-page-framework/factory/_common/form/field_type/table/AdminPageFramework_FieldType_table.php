...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_table extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'faculty-weekly-schedule-field-type-table', 'src' => dirname(__FILE__) . '/js/table.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'jquery-ui-accordion', 'faculty-weekly-schedule-script-form-main' ), 'translation_var' => 'FacultyWeeklySchedule_AdminPageFrameworkFieldTypeTable', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
    ...
    private function ___getLabel($aField)
    {
        ...
        return "<div class='faculty-weekly-schedule-input-label-container'>" . "<label for='" . esc_attr($aField[ 'input_id' ]) . "'>" . "<span " . $this->getLabelContainerAttributes($aField, 'faculty-weekly-schedule-input-label-string') . ">" . $aField[ 'label' ] . "</span>" . "</label>" . "</div>";
    }
    private function ___getTable($aField)
    {
        ...
        $_sCaption = $aField[ 'caption' ] ? $aField[ 'caption' ] : __('Set the caption with the <code>caption</code> argument.', 'faculty-weekly-schedule');
