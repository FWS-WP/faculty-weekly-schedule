...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_select extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field-select .faculty-weekly-schedule-input-label-container {vertical-align: top; }.faculty-weekly-schedule-field-select .faculty-weekly-schedule-input-label-container {padding-right: 1em;}";
    }
    ...
    class FacultyWeeklySchedule_AdminPageFramework_FieldType_size extends FacultyWeeklySchedule_AdminPageFramework_FieldType_select {
        ...
        protected function getStyles() {
            return ".faculty-weekly-schedule-field-size input {text-align: right;}.faculty-weekly-schedule-field-size select.size-field-select {vertical-align: 0px; }.faculty-weekly-schedule-field-size label {width: auto; } .form-table td fieldset .faculty-weekly-schedule-field-size label {display: inline-block;}";
        }
        protected function getField($aField) {
