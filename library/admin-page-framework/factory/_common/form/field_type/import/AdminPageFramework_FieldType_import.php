...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_import extends FacultyWeeklySchedule_AdminPageFramework_FieldType_submit {
    ...
    {
        return array( array( 'handle_id' => 'faculty-weekly-schedule-field-type-import', 'src' => dirname(__FILE__) . '/js/import.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'faculty-weekly-schedule-script-form-main' ), 'translation_var' => 'FacultyWeeklySchedule_AdminPageFrameworkImportFieldType', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array( 'noFile' => $this->oMsg->get('import_no_file'), ), ), ), );
    }
