...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_submit extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'faculty-weekly-schedule-submit-field-type', 'src' => dirname(__FILE__) . '/js/submit.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', ), ), );
    }
    ...
    {
        return array( 'style' => $aField[ 'label_min_width' ] || '0' === ( string ) $aField[ 'label_min_width' ] ? "min-width:" . $this->getLengthSanitized($aField[ 'label_min_width' ]) . ";" : null, 'class' => 'faculty-weekly-schedule-input-label-container' . ' faculty-weekly-schedule-input-button-container' . ' faculty-weekly-schedule-input-container', );
    }
