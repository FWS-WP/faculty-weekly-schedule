...
abstract class FacultyWeeklySchedule_AdminPageFramework_FieldType_Base extends FacultyWeeklySchedule_AdminPageFramework_Form_Utility {
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
    ...
    class FacultyWeeklySchedule_AdminPageFramework_FieldType_color extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.faculty-weekly-schedule-field-color .wp-picker-container {vertical-align: middle;}.faculty-weekly-schedule-field-color .ui-widget-content {border: none;background: none;color: transparent;}.faculty-weekly-schedule-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.faculty-weekly-schedule-field-color .faculty-weekly-schedule-repeatable-field-buttons {margin-top: 0;}.faculty-weekly-schedule-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
            $_aJSArray = json_encode($this->aFieldTypeSlugs);
            $_sDoubleQuote = '\"';
            return <<<JAVASCRIPTS
registerFacultyWeeklySchedule_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
...
JAVASCRIPTS;
        ...
        protected function getField($aField) {
            ...
            return $aField['before_label'] . "<div class='faculty-weekly-schedule-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'faculty-weekly-schedule-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
        }
...
jQuery( document ).ready( function(){
    registerFacultyWeeklySchedule_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
