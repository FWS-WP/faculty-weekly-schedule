...
class FacultyWeeklySchedule_AdminPageFramework_FieldType_radio extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".faculty-weekly-schedule-field input[type='radio'] {margin-right: 0.5em;} .faculty-weekly-schedule-field-radio .faculty-weekly-schedule-input-label-container {padding-right: 1em;} .faculty-weekly-schedule-field-radio .faculty-weekly-schedule-input-container {display: inline;} .faculty-weekly-schedule-field-radio .faculty-weekly-schedule-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.faculty-weekly-schedule-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );
