...
class FacultyWeeklySchedule_AdminPageFramework_Form_Model___SetFieldResources extends FacultyWeeklySchedule_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_Form', 'FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_Field', 'FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_Section', 'FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_FieldError', 'FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('FacultyWeeklySchedule_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
