...
class FacultyWeeklySchedule_AdminPageFramework_Form_Model___FormatFieldsets extends FacultyWeeklySchedule_AdminPageFramework_Form_Base {
    ...
    {
        $_oDynamicElements = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___FormatDynamicElements($this->aSectionsets, $this->aFieldsets, $this->aSavedData);
    ...
    private function ___getFieldsetFormatted($aFieldset, $aSectionsets, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject)
    {
        ...
        $_oFieldsetFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $this->sStructureType, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject);
