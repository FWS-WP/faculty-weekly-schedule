...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Generate_FieldInputName extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
