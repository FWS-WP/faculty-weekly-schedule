...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Attribute_Base {
    ...
    {
        return array( 'id' => $this->sSectionsID, 'class' => $this->getClassAttribute('faculty-weekly-schedule-sections', $this->getAOrB(! $this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'faculty-weekly-schedule-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'faculty-weekly-schedule-collapsible-sections-content' . ' ' . 'faculty-weekly-schedule-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset[ 'repeatable' ]), null, 'repeatable-section'), $this->getAOrB(empty($this->aSectionset[ 'sortable' ]), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset[ 'section_id' ], 'data-section_address' => $this->aSectionset[ 'section_id' ], 'data-section_address_model' => $this->aSectionset[ 'section_id' ] . '|' . '___i___', ) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset)
    {
        ...
        $_oSectionNameGenerator = new FacultyWeeklySchedule_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset[ '_caller_object' ]->aCallbacks[ 'hfSectionName' ]);
