...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___FieldTitle extends FacultyWeeklySchedule_AdminPageFramework_Form_Utility {
    ...
    public function get()
    {
        ...
        $_oInputTagIDGenerator = new FacultyWeeklySchedule_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
        $_aLabelAttributes = array( 'class' => $this->getClassAttribute('faculty-weekly-schedule-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(), );
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField)
    {
        ...
        foreach ($aField[ 'content' ] as $_aNestedField) {
            ...
            $_oFieldset = new FacultyWeeklySchedule_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
    ...
    {
        $_oToolTip = new FacultyWeeklySchedule_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
