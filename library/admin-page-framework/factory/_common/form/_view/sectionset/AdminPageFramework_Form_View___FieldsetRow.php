...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___FieldsetRow extends FacultyWeeklySchedule_AdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get()
    {
        ...
        $_oFieldrowAttribute = new FacultyWeeklySchedule_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
