...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___SectionRepeatableButtons extends FacultyWeeklySchedule_AdminPageFramework_Form_Utility {
    public static function get($sContainerTagID, $iSectionCount, $asArguments, $oMsg)
    {
        ...
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Format_RepeatableSection($asArguments, $oMsg);
