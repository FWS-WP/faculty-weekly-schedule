...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___DebugInfo extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    public function get()
    {
        ...
        return "<div class='faculty-weekly-schedule-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
