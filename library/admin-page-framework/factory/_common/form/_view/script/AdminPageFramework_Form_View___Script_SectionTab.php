...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_SectionTab extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.faculty-weekly-schedule-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='faculty-weekly-schedule-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
