...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_RepeatableField extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Base {
...
// @todo event.preventDefault();        
    ...
    $.fn.addFacultyWeeklySchedule_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( 'undefined' === typeof sFieldContainerID ) {
            var sFieldContainerID = $( this ).closest( '.faculty-weekly-schedule-field' ).attr( 'id' );
        }
