...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_RegisterCallback extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */  
    $( document ).bind( 'faculty-weekly-schedule_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     */
    $( document ).bind( 'faculty-weekly-schedule_repeated_field', function( oEvent, iCallType, oModelContainer ){
     ...
     * @since       3.8.0
     */
    $( document ).bind( 'faculty-weekly-schedule_stopped_sorting_sections', function( oEvent ){  
     ...
     */
    /* $( document ).bind( 'faculty-weekly-schedule_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
     ...
     * @since    3.2.0 
     */
    $( document ).bind( 'faculty-weekly-schedule_saved_widget', function( event, oWidget ){
