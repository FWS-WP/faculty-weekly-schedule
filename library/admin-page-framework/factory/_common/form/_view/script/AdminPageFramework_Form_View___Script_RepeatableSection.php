...
class FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_RepeatableSection extends FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
    ...
    $.fn.addFacultyWeeklySchedule_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        ...
        if ( 'undefined' === typeof sSectionContainerID ) {
            var sSectionContainerID = $( this ).closest( '.faculty-weekly-schedule-section' ).attr( 'id' );
        }
...
jQuery( document ).ready( function() {
    ...
    // Adds the buttons
    jQuery( '#{$sContainerTagID} .faculty-weekly-schedule-section-caption' ).each( function(){
        
        jQuery( this ).show();
        
        var _oButtons = jQuery( $_sButtonsHTML );
        if ( jQuery( this ).children( '.faculty-weekly-schedule-collapsible-section-title' ).children( 'fieldset' ).length > 0 ) {
            _oButtons.addClass( 'section_title_field_sibling' );
        }
        var _oCollapsibleSectionTitle = jQuery( this ).find( '.faculty-weekly-schedule-collapsible-section-title' );
    ...
    // Update the fields     
    jQuery( '#{$sContainerTagID}' ).updateFacultyWeeklySchedule_AdminPageFrameworkRepeatableSections( $_aJSArray ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='faculty-weekly-schedule-section-repeatable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    ...
    static private function ___getContainerAttributes(array $aArguments, $oMsg) {
        $_aAttriubtes = array('class' => self::getClassAttribute('faculty-weekly-schedule-repeatable-section-buttons', empty($aArguments['disabled']) ? '' : 'disabled'),);
