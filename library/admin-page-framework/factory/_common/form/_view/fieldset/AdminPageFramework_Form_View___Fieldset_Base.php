...
abstract class FacultyWeeklySchedule_AdminPageFramework_Form_View___Fieldset_Base extends FacultyWeeklySchedule_AdminPageFramework_Form_Utility {
    ...
    {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset[ 'type' ], $aFieldTypeDefinitions) + FacultyWeeklySchedule_AdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    protected function _getRepeatableFieldButtons($sFieldsContainerID, $iFieldCount, $aSettings)
    {
        ...
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Format_RepeatableField($_aSettings, $this->oMsg);
    ...
    {
        $_aContainerAttributes = array( 'class' => $this->getClassAttribute('faculty-weekly-schedule-repeatable-field-buttons', ! empty($aArguments[ 'disabled' ]) ? 'disabled' : ''), );
