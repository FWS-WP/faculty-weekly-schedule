...
abstract class FacultyWeeklySchedule_AdminPageFramework_Form_View___Fieldset_Base extends FacultyWeeklySchedule_AdminPageFramework_Form_Utility {
    ...
    private function _loadScripts($sStructureType = '') {
        if ('widget' === $sStructureType && !self::$_bIsLoadedJSScripts_Widget) {
            new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Widget;
        ...
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_Utility;
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_OptionStorage;
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_AttributeUpdator;
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_RepeatableField($this->oMsg);
        new FacultyWeeklySchedule_AdminPageFramework_Form_View___Script_SortableField;
    }
...
jQuery( document ).ready( function() {
    var _oButtonPlaceHolders = jQuery( '#{$sFieldsContainerID} > .faculty-weekly-schedule-field.without-child-fields .repeatable-field-buttons' );
    ...
    /* Otherwise, insert the button element at the beginning of the field tag */
         ...
         */
        if ( ! jQuery( '#{$sFieldsContainerID} .faculty-weekly-schedule-repeatable-field-buttons' ).length ) { 
            jQuery( '#{$sFieldsContainerID} > .faculty-weekly-schedule-field.without-nested-fields' ).prepend( $_sSmallButtons );
        }
        /**
         * Support for nested fields.
         * For nested fields, add the buttons to the fields tag.
         */
        jQuery( '#{$sFieldsContainerID} > .faculty-weekly-schedule-field.with-nested-fields' ).prepend( $_sNestedFieldsButtons );
        
        /**
         * Support for inline mixed fields.
         */
        // jQuery( '#{$sFieldsContainerID} > .faculty-weekly-schedule-field.with-mixed-fields' ).prepend( $_sNestedFieldsButtons );
        
    }     
    jQuery( '#{$sFieldsContainerID}' ).updateFacultyWeeklySchedule_AdminPageFrameworkRepeatableFields( $_aJSArray ); // Update the fields     
});
JAVASCRIPTS;
    ...
    private function ___getRepeatableButtonHTML($sFieldsContainerID, array $aArguments, $iFieldCount, $bSmall = true) {
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Form_Model___Format_RepeatableField($aArguments, $this->oMsg);
    ...
    protected function _getSortableFieldEnablerScript($sFieldsContainerID) {
        $_sScript = <<<JAVASCRIPTS
    jQuery( document ).ready( function() {
        jQuery( this ).enableFacultyWeeklySchedule_AdminPageFrameworkSortableFields( '$sFieldsContainerID' );
    });
JAVASCRIPTS;
        return "<script type='text/javascript' class='faculty-weekly-schedule-sortable-field-enabler-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
