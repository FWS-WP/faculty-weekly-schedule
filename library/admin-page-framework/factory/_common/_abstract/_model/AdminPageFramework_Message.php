...
class FacultyWeeklySchedule_AdminPageFramework_Message {
    ...
    private function ___doDummy() {
        ...
        __('This information will be disabled when <code>WP _ DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'faculty-weekly-schedule');
