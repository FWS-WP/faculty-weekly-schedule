...
abstract class FacultyWeeklySchedule_AdminPageFramework_Property_Base extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType)
    {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'faculty-weekly-schedule' : $sTextDomain;
    ...
    {
        if (! isset($GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ])) {
            $GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ] = array( 'aFieldFlags' => array() );
        }
    }
    ...
    {
        self::$_aLibraryData = array( 'sName' => FacultyWeeklySchedule_AdminPageFramework_Registry::NAME, 'sURI' => FacultyWeeklySchedule_AdminPageFramework_Registry::URI, 'sScriptName' => FacultyWeeklySchedule_AdminPageFramework_Registry::NAME, 'sLibraryName' => FacultyWeeklySchedule_AdminPageFramework_Registry::NAME, 'sLibraryURI' => FacultyWeeklySchedule_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => FacultyWeeklySchedule_AdminPageFramework_Registry::getVersion(), 'sDescription' => FacultyWeeklySchedule_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => FacultyWeeklySchedule_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => FacultyWeeklySchedule_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => FacultyWeeklySchedule_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => FacultyWeeklySchedule_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '', );
    ...
    public function __get($sName)
    {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new FacultyWeeklySchedule_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
