...
abstract class FacultyWeeklySchedule_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array( 'oForm' => 'FacultyWeeklySchedule_AdminPageFramework_Form_', 'oPageLoadInfo' => 'FacultyWeeklySchedule_AdminPageFramework_PageLoadInfo_', 'oResource' => 'FacultyWeeklySchedule_AdminPageFramework_Resource_', 'oHelpPane' => 'FacultyWeeklySchedule_AdminPageFramework_HelpPane_', 'oLink' => 'FacultyWeeklySchedule_AdminPageFramework_Link_', );
    private $_aSubClassNames = array( 'oProp' => null, 'oDebug' => 'FacultyWeeklySchedule_AdminPageFramework_Debug', 'oUtil' => 'FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility', 'oMsg' => 'FacultyWeeklySchedule_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null, );
    ...
    {
        trigger_error(FacultyWeeklySchedule_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString()
    {
        return FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
