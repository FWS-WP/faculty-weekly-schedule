...
abstract class FacultyWeeklySchedule_AdminPageFramework_Factory_View extends FacultyWeeklySchedule_AdminPageFramework_Factory_Model {
    public function __construct($oProp)
    {
        parent::__construct($oProp);
        new FacultyWeeklySchedule_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
