...
abstract class FacultyWeeklySchedule_AdminPageFramework_Resource_Base extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'faculty-weekly-schedule-style';
    protected $_sClassSelector_Script = 'faculty-weekly-schedule-script';
    ...
    {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array( "style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}", ), FacultyWeeklySchedule_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName)
    {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array( "script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}", ), FacultyWeeklySchedule_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle()
    {
        ...
        $this->_printCommonStyles('faculty-weekly-schedule-style-common', get_class());
    ...
    public function _replyToAddScript()
    {
        ...
        $this->_printCommonScripts('faculty-weekly-schedule-script-common', get_class());
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(FacultyWeeklySchedule_AdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => FacultyWeeklySchedule_AdminPageFramework_Registry::VERSION, ), 'style');
    }
