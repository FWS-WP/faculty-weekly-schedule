...
abstract class FacultyWeeklySchedule_AdminPageFramework_Resource_Base extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    private function ___getCommonStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), FacultyWeeklySchedule_AdminPageFramework_CSS::getDefaultCSS());
