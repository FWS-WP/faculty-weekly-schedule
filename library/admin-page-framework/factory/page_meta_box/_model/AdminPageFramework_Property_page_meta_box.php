...
class FacultyWeeklySchedule_AdminPageFramework_Property_page_meta_box extends FacultyWeeklySchedule_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability='manage_options', $sTextDomain='faculty-weekly-schedule', $sStructureType='page_meta_box')
    {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aFacultyWeeklySchedule_AdminPageFramework', 'aMetaBoxForPagesClasses' ));
        $GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ][ $sClassName ] = $oCaller;
    }
    ...
    {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array( 'aFacultyWeeklySchedule_AdminPageFramework', 'aPageClasses' ));
