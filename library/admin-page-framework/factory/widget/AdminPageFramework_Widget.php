...
abstract class FacultyWeeklySchedule_AdminPageFramework_Widget extends FacultyWeeklySchedule_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct()
    {
        $_sThisClassName = get_class($this);
        $_bAssumedAsWPWidget = 0 === func_num_args();
        $_aDefaults = array( '', array(), 'edit_theme_options', 'faculty-weekly-schedule' );
