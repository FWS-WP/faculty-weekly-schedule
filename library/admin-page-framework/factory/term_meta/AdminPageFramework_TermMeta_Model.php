...
abstract class FacultyWeeklySchedule_AdminPageFramework_TermMeta_Model extends FacultyWeeklySchedule_AdminPageFramework_TermMeta_Router {
    ...
    {
        $_oMetaData = new FacultyWeeklySchedule_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
