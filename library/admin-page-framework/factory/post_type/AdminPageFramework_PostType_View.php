...
abstract class FacultyWeeklySchedule_AdminPageFramework_PostType_View extends FacultyWeeklySchedule_AdminPageFramework_PostType_Model {
    ...
    public function _replyToPrintStyle()
    {
        ...
        if (! empty($_sStyle)) {
            echo "<style type='text/css' id='faculty-weekly-schedule-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
        $this->oProp->sStyle = '';
    }
