...
abstract class FacultyWeeklySchedule_AdminPageFramework_PostType_Model extends FacultyWeeklySchedule_AdminPageFramework_PostType_Router {
    public function __construct($oProp)
    {
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new FacultyWeeklySchedule_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType()
    {
        ...
        new FacultyWeeklySchedule_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
