...
abstract class FacultyWeeklySchedule_AdminPageFramework_MetaBox_Model extends FacultyWeeklySchedule_AdminPageFramework_MetaBox_Router {
    ...
    {
        $_oMetaData = new FacultyWeeklySchedule_AdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
