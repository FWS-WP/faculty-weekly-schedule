...
class FacultyWeeklySchedule_AdminPageFramework_View__Resource extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    {
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    {
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_PageResource_Script($asPageScript);
