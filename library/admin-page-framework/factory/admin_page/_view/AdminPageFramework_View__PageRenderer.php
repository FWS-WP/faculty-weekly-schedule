<?php
class FacultyWeeklySchedule_AdminPageFramework_View__PageRenderer extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render()
    {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="faculty-weekly-schedule-container">
                <?php
 ...
 $this->_printMainPageContent($_sPageSlug, $_sTabSlug);
        $this->_printPageMetaBoxes(); ?>
            ...
            </div><!-- .faculty-weekly-schedule-container -->
 ...
 $this->addAndDoActions($this->oFactory, $this->getFilterArrayByPrefix('do_after_', $this->oFactory->oProp->sClassName, $_sPageSlug, $_sTabSlug, true), $this->oFactory);
    ...
    {
        $_oScreenIcon = new FacultyWeeklySchedule_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new FacultyWeeklySchedule_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop .= $_oPageHeadingTabs->get();
        $_oInPageTabs = new FacultyWeeklySchedule_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug)
    {
        ...
        echo "<div class='faculty-weekly-schedule-content'>";
        ...
        echo "</div><!-- .faculty-weekly-schedule-content -->";
    }
    ...
    {
        $_oPageMetaBoxRenderer = new FacultyWeeklySchedule_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm=true)
    {
        ...
        echo "<form " . $this->getAttributes(array( 'method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'faculty-weekly-schedule-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)), )) . " >" . PHP_EOL;
