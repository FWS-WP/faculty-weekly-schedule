...
abstract class FacultyWeeklySchedule_AdminPageFramework_Controller extends FacultyWeeklySchedule_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector='error', $sID='')
    {
        ...
        new FacultyWeeklySchedule_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[ $sID ][ 'sMessage' ], $this->oProp->aAdminNotices[ $sID ][ 'aAttributes' ], array( 'should_show' => array( $this, 'isInThePage' ), ));
    }
    ...
    {
        return FacultyWeeklySchedule_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
