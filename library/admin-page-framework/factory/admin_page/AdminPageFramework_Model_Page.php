...
abstract class FacultyWeeklySchedule_AdminPageFramework_Model_Page extends FacultyWeeklySchedule_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs()
    {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[ $_sPageSlug ], $_sPageSlug, $this);
