...
abstract class FacultyWeeklySchedule_AdminPageFramework_Controller_Menu extends FacultyWeeklySchedule_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink)
    {
        ...
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage)
    {
        ...
        $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
