...
abstract class FacultyWeeklySchedule_AdminPageFramework_Router extends FacultyWeeklySchedule_AdminPageFramework_Factory {
    public $oProp;
    public $oForm;
    ...
    public function _replyToLoadComponentsForAjax()
    {
        ...
        new FacultyWeeklySchedule_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
