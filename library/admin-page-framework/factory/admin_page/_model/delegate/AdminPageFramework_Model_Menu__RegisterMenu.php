...
class FacultyWeeklySchedule_AdminPageFramework_Model_Menu__RegisterMenu extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems()
    {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new FacultyWeeklySchedule_AdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
