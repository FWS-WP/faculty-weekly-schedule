...
class FacultyWeeklySchedule_AdminPageFramework_Property_admin_page extends FacultyWeeklySchedule_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability='manage_options', $sTextDomain='faculty-weekly-schedule')
    {
        ...
        $GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ][ 'aPageClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aFacultyWeeklySchedule_AdminPageFramework', 'aPageClasses' ));
        $GLOBALS[ 'aFacultyWeeklySchedule_AdminPageFramework' ][ 'aPageClasses' ][ $sClassName ] = $oCaller;
