...
class FacultyWeeklySchedule_AdminPageFramework_FormEmail extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('faculty-weekly-schedule_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('faculty-weekly-schedule_action_after_sending_form_email', $_bSent, $_aEmailOptions);
