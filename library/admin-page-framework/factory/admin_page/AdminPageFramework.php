...
abstract class FacultyWeeklySchedule_AdminPageFramework_Router extends FacultyWeeklySchedule_AdminPageFramework_Factory {
    ...
    abstract class FacultyWeeklySchedule_AdminPageFramework_Model_Form extends FacultyWeeklySchedule_AdminPageFramework_Router {
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'faculty-weekly-schedule') {
            ...
            new FacultyWeeklySchedule_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    abstract class FacultyWeeklySchedule_AdminPageFramework extends FacultyWeeklySchedule_AdminPageFramework_Controller {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? FacultyWeeklySchedule_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
