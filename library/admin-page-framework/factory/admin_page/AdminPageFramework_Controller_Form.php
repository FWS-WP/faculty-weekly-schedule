...
abstract class FacultyWeeklySchedule_AdminPageFramework_Controller_Form extends FacultyWeeklySchedule_AdminPageFramework_View_Form {
    ...
    public function getValue()
    {
        ...
        return FacultyWeeklySchedule_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
