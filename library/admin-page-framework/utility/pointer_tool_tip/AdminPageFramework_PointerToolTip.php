...
class FacultyWeeklySchedule_AdminPageFramework_PointerToolTip extends FacultyWeeklySchedule_AdminPageFramework_FrameworkUtility {
    ...
    {
        echo "<script type='text/javascript' class='faculty-weekly-schedule-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->___getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
