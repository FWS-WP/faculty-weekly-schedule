...
abstract class FacultyWeeklySchedule_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    {
        if (! class_exists('FacultyWeeklySchedule_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new FacultyWeeklySchedule_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
