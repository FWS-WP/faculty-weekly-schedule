    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            removeInputValuesForPath = function( oElem ) {
                jQuery( oElem )
                    .closest( '.faculty-weekly-schedule-field' )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='faculty-weekly-schedule-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setFacultyWeeklySchedule_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='faculty-weekly-schedule-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'faculty-weekly-schedule-field-type-pack' )
                            )
                        )
                    ."</a>";
