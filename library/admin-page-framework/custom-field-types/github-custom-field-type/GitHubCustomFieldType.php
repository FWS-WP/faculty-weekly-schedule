<?php
if ( ! class_exists( 'FacultyWeeklySchedule_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class FacultyWeeklySchedule_GitHubCustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='faculty-weekly-schedule-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='faculty-weekly-schedule-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'faculty-weekly-schedule' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'faculty-weekly-schedule' );
                case 'star':
                    return __( 'Star', 'faculty-weekly-schedule' );
                case 'fork':
                    return __( 'Fork', 'faculty-weekly-schedule' );
                case 'issue':
                    return __( 'Issue', 'faculty-weekly-schedule' );
                default:
                    return '';
            }                 
