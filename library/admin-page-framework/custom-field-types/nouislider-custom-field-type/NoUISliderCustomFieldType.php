...
if ( ! class_exists( 'FacultyWeeklySchedule_NoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class FacultyWeeklySchedule_NoUISliderCustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType_text {
