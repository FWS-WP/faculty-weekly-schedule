 ...
 * @package     FacultyWeeklySchedule_AdminPageFramework
 */

if ( ! class_exists( 'FacultyWeeklySchedule_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class FacultyWeeklySchedule_PostTypeTaxonomyCustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.faculty-weekly-schedule-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllFacultyWeeklySchedule_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.faculty-weekly-schedule-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllFacultyWeeklySchedule_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.faculty-weekly-schedule-field-post_type_taxonomy .faculty-weekly-schedule-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.faculty-weekly-schedule-field-post_type_taxonomy' );
    ...
    jQuery( '.faculty-weekly-schedule-field-post_type_taxonomy .faculty-weekly-schedule-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerFacultyWeeklySchedule_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.faculty-weekly-schedule-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.faculty-weekly-schedule-field-post_type_taxonomy .select_all_button_container, 
.faculty-weekly-schedule-field-post_type_taxonomy .select_none_button_container
{
...
.faculty-weekly-schedule-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'faculty-weekly-schedule-loader' )
                    . "</label>"
                . "</div>";
