...
if ( ! class_exists( 'FacultyWeeklySchedule_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class FacultyWeeklySchedule_ToggleCustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.faculty-weekly-schedule-field' )
                    .children( '.faculty-weekly-schedule-checkbox-container-toggle' )
                    .hide();
