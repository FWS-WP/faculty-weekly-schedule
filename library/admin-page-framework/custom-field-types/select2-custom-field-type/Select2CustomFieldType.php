...
if ( ! class_exists( 'FacultyWeeklySchedule_Select2CustomFieldType' ) ) :
/**
 ...
 */
class FacultyWeeklySchedule_Select2CustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'search_callback' ] ) {
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.faculty-weekly-schedule-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.faculty-weekly-schedule-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.faculty-weekly-schedule-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .faculty-weekly-schedule-field-select2 > .faculty-weekly-schedule-select-label > label > .faculty-weekly-schedule-input-container {
    max-width: 84%;
}
