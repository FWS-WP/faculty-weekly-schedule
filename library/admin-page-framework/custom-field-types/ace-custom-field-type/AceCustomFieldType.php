<?php
/**
 * FacultyWeeklySchedule_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'FacultyWeeklySchedule_AceCustomFieldType' ) ) :
class FacultyWeeklySchedule_AceCustomFieldType extends FacultyWeeklySchedule_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.faculty-weekly-schedule-field' ).nextAll().andSelf().each( function( iIndex ) {
